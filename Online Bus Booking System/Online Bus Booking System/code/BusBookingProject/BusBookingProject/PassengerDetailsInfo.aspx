                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlBank" runat="server" class="form-control input-sm floatlabel">
                                ...
                                <asp:ListItem Value="1" Text="National Bank of Egypt"></asp:ListItem>
                                <asp:ListItem Value="2" Text="Banque Misr"></asp:ListItem>
                                <asp:ListItem Value="3" Text="Housing and Development Bank"></asp:ListItem>
                                <asp:ListItem Value="4" Text="Credit Agricole Egypt"></asp:ListItem>
                                <asp:ListItem Value="5" Text="Arab African International Bank"></asp:ListItem>
                            </asp:DropDownList>
