        ...
        <div class="col-lg-8 col-sm-8 col-md-2 col-sm-offset-2 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Add Plane Schedule</h3>
                </div>
                <div class="panel-body">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtDate" runat="server" placeholder="DD/MM/YYYY Format" class="form-control input-sm floatlabel" TextMode="DateTime" />
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtArrival" runat="server" placeholder="00:00 AM/PM Format" class="form-control input-sm floatlabel"  TextMode="Time" />
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="txtDeparture" placeholder="00:00 AM/PM Format"  runat="server" class="form-control input-sm floatlabel" TextMode="Time" />
